...
test_that(".mult_vec_mat preserves rownames and colnames", {
  set.seed(1)
  n <- 10
  vec <- round(100*runif(n))
  mat <- matrix(100*runif(n^2), n, n)
...
test_that(".mult_mat_vec preserves rownames and colnames", {
  set.seed(1)
  n <- 10
  vec <- round(100*runif(n))
  mat <- matrix(100*runif(n^2), n, n)
